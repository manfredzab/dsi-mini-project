...
/**
 * Leapfrog join iterator class. It is based on an abstract multiway sort-merge join iterator, with the
 * exception that it uses the linear iterator portions of the binary tree trie iterator to seek the current
 * iterator to the next candidate key.
 */
